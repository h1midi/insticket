                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            dateTimeFormat('MMMEd', widget.gameDetails.date),
                            textAlign: TextAlign.center,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              dateTimeFormat('jm', widget.gameDetails.date),
                              style: FlutterTheme.of(context).bodyText2,
                            ),
                          ],
                        ),
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              final gamesUpdateData = {
                                ...
                                'covered_num_current': FieldValue.increment(1),
                              };
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              final gamesUpdateData = {
                                ...
                                'normal_num_current': FieldValue.increment(1),
                              };
                              await widget.gameDetails.reference
                                  .update(gamesUpdateData);
                              await Navigator.push(
